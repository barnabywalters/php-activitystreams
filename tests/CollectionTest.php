...
// Include Class files (not autoloading as an autoloader bug should not compromise these tests)
$autoloader = require_once dirname(__DIR__) . '/ActivityStreams/ActivityStreams/Collection.php';
$autoloader = require_once dirname(__DIR__) . '/ActivityStreams/ActivityStreams/Activity.php';
$autoloader = require_once dirname(__DIR__) . '/ActivityStreams/ActivityStreams/Object.php';
$autoloader = require_once dirname(__DIR__) . '/ActivityStreams/ActivityStreams/LinkObject.php';
