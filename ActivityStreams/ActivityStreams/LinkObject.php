...
class LinkObject extends Object {
     ...
     * HrefLang
     * 
     * Should be an RFC4646 language tag giving a hint as to the language of the
     * linked resource
     * 
     * RFC4646 language tags are made of hyphen-separated subtags, for example 
     * "en-GB".
     * 
     ...
     * Title
     * 
     * Human-readable plaintext (no HTML) title for the webpage. Typically the 
     * value of the pages `title` element if HTML
     * 
     */
    public $title;
